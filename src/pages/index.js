...
export default function Home() {
    ...
    const [inputName, setInputName] = useState('Ulaanbaatar');
    ...
    return (
        <div className="flex">
             {/* === Search and Weather Card === */}
                <div className="absolute left-1/2 top-10 transform -translate-x-1/2 w-2/3 max-w-md z-30">
                    {/* Search Input */}
                    ...
                    <div className="space-y-12 px-10 py-14">
                        ...
                        <div className="px-10">
                            <div className="text-transparent bg-clip-text font-extrabold text-[90px] -mt-10 bg-gradient-to-b from-white to-gray-300">
                                ...
                                {nightData?.length > 0 ? `${nightData[0].temp_c}°` : "No Data"}
                            </div>
                            <p className="font-extrabold mb-12 h-6 text-blue-300">
                                {/* {nightData && nightData[0]?.condition.text} */}
                                {nightData?.length > 0 ? nightData[0].condition.text : "Unknown"}
                            </p>
